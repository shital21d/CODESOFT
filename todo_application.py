...
if __name__ == "__main__":
    ...
    # setting the background color to #F0F8FF
    ...
    header_frame = tk.Frame(guiWindow, bg="#F0F8FF")
    functions_frame = tk.Frame(guiWindow, bg="#F0F8FF")
    listbox_frame = tk.Frame(guiWindow, bg="#F0F8FF")
